    ...
    >
      <div className="max-w-3xl mx-auto text-center mb-16">
        <p className="text-xl leading-relaxed text-muted-foreground">
          ...
          business ethos. We believe in growing together with the community. Our
          CSR initiatives focus on education, healthcare, and rural development.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 justify-items-center">
        {INITIATIVES.map((item, i) => (
          <motion.div
            ...
            className="group bg-card border rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 w-full"
          >
            <div className="h-48 overflow-hidden relative">
              <img
                ...
                alt={item.title}
                onError={(e) =>
                  (e.target.src = "https://placehold.co/600x400?text=CSR")
                }
      ...
      >
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Beyond business, we are committed to making a tangible difference in
          the lives of people. Our goal is to empower rural communities and help
